...
Software Engineer with 4+ years of experience building high-throughput distributed systems.
At Walmart Global Tech, shipped campaign management and reporting infrastructure processing
100M+ events/day with sub-15-minute SLAs and 200K+ external API requests/day.
Currently finishing an MS in Computer Science at UIC (GPA 4.0) and applying those
systems instincts to production AI — RAG pipelines, agentic workflows, and LLM inference.
